...
/** The span rule: a rider is active iff its factor is not generated by the convention. */
export function riderActive(conv: Convention, rider: Rider): boolean {
  if (rider.factorDim === null) return true
  return solveRestoration(conv, rider.factorDim).kind === "inconsistent"
}
...
export const CONVENTIONS: Record<string, Convention> = {
  ...
  "nr-code": {
    ...
    generators: [
      g("c", CONST_DIM.c, "1", "c"),
      g("G", CONST_DIM.G, "1", "G"),
      { tex: "M_\\odot", dim: dimQ(1, 0, 0, 0, 0), numericFactor: "1", emits: "M_\\odot", kind: "reference_model", role: "absorbed", value: "1.988e30 kg (store GM_⊙ as primary — census T9)" },
    ],
  },
  "geometrized-hl": {
